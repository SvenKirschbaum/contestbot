...
public class AuthProvider {
    private static LoadingCache<String, Boolean> cache = CacheBuilder.newBuilder().concurrencyLevel(2).maximumSize(40)
            .expireAfterWrite(24, TimeUnit.HOURS).build(new CacheLoader<String, Boolean>() {
                @Override
